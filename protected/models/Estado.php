...
class Estado extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('nm_estado, observacao', 'required'),
			array('nm_estado', 'length', 'max'=>45),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id_estado, nm_estado, observacao', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
                    'cidade' => array(self::HAS_MANY, 'Cidade', 'id_estado'),
		);
	}
